...
def tracked_email_sender(user_id, recipient, subject, body, cc=None, bcc=None, in_reply_to_message_id=None, in_reply_sendOrRec=None):
    ...
    try:
        ...
        dsn_headers = {
            'Disposition-Notification-To': settings.DEFAULT_FROM_EMAIL,
            'Return-Receipt-To': settings.DEFAULT_FROM_EMAIL,
            'X-Confirm-Reading-To': settings.DEFAULT_FROM_EMAIL
        }
        
        headers.update(dsn_headers)
